...
## **Tuesday - PULL #1 (Lat focused)**
**Exercises & Reps**
- **Lat Pulldown**: 2x15  
- **Rear Delt Flies**: 3x10  
- **Machine Row**: 2x to failure  
- **Lat Prayer**: 4x15  
- **Hammer Curls**: 3x10  
...
## **Wednesday - LEGS #1 (Quad focused)**
**Exercises & Reps**
- **Squats**: 3x6-8  
- **Bulgarian Splits**: 4x10  
- **Leg Extension**: 2x10 → Into **Sissy Squats** Superset 2x10  
- **Hip Abduction Machine**: 3x8-10  
...
## **Friday - PUSH #2 (+cardio/abs)**
**Exercises & Reps**
- **Dumbbell Shoulder Press**: 3x8-10  
- **Incline Smith Machine**: 4x10  
- **Cable Lateral Raises**: 3x15  
- **Dumbbell Y’s**: 2x15  
- **Single Arm Cable Push Down**: 3x10  
- **Machine Dips**: 4x10  

---

## **Saturday - PULL #2 (Mid/Upper Back Focused)**
**Exercises & Reps**
- **Barbell Row**: 3x6-8  
- **Single Arm Cable Pulldown**: 2x15  
- **Face Pulls**: 3x10  
- **Seated V-Bar Row**: 4x15  
- **Dumbbell Curls**: 3x12  
- **Cross Body DB Curls**: 3x10  

---

## **Sunday - LEGS #2 (Hamstring Focused)**
**Exercises & Reps**
- **Hip Thrusts**: 4x8-10  
- **Dumbbell RDL’s**: 3x10  
